...
DECLARE_GENERIC_CACHEP(hk_cmt_jnl_info, GFP_ATOMIC);
DECLARE_GENERIC_CACHEP(hk_cmt_data_info, GFP_ATOMIC);
DECLARE_GENERIC_CACHEP(hk_cmt_attr_info, GFP_ATOMIC);
DECLARE_GENERIC_CACHEP(hk_cmt_inode_info, GFP_ATOMIC);
