					   ...
					   struct hk_inode_info_header *sih)
{
	...
	// TODO: May be we should maintain a invalid pending list ? 
	/* prevent the after blk written back to before blk */
	up_invalidator(sb);

	freed = hk_free_inode_blks_no_invalidators(sb, pi, sih);
